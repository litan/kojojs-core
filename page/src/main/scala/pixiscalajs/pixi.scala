...
class ParticleRenderer protected () extends ObjectRenderer {
  ...
  var uploadPosition: js.Function6[js.Array[DisplayObject], Double, Double, js.Array[Double], Double, Double, Unit] =
    js.native
  var uploadRotation: js.Function6[js.Array[DisplayObject], Double, Double, js.Array[Double], Double, Double, Unit] =
    js.native
  var uploadUvs: js.Function6[js.Array[DisplayObject], Double, Double, js.Array[Double], Double, Double, Unit] = js.native
  var uploadVertices: js.Function6[js.Array[DisplayObject], Double, Double, js.Array[Double], Double, Double, Unit] =
    js.native
}
...
package extras {
  ...
  object TilingSprite extends js.Object {
    ...
    def fromImage(imageId: String, width: Double, height: Double, crossorigin: Boolean, scaleMode: Double): TilingSprite =
      js.native
  }
